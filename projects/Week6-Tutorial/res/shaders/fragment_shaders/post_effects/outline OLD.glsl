...
void main() {
    ...
    vec4 OutlineColorMix = u_OutlineColor;

    if (edgeDepth.r<=u_DepthRange)
    {
        OutlineColorMix = u_OutlineColor2;
    }
    vec3 result = (OutlineColorMix.rgb * OutlineColorMix.a * edgeFactor) + (1 - edgeFactor) * color;
