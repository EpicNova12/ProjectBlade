...
void DefaultSceneLayer::_CreateScene()
{
	...
	if (loadScene && std::filesystem::exists("scene.json")) {
		...
		GameObject::Sptr monkey1 = scene->CreateGameObject("Monkey 1");
		{
			...
			monkey1->SetPostion(glm::vec3(1.5f, -10.0f, -10.0f));
		...
		GameObject::Sptr monkey2 = scene->CreateGameObject("Complex Object");
		{
			...
			monkey2->SetPostion(glm::vec3(0.0f, 0.0f, 1.0f));
			monkey2->SetRotation(glm::vec3(0.0f, 0.0f, 0.0f));
		...
		GameObject::Sptr monkey21 = scene->CreateGameObject("Complex Object");
		{
			// Set and rotation position in the scene
			monkey21->SetPostion(glm::vec3(0.0f, 3.0f, 0.280f));
			monkey21->SetRotation(glm::vec3(0.0f, 45.0f, 90.0f));

			// Add a render component
			RenderComponent::Sptr renderer = monkey21->Add<RenderComponent>();
			renderer->SetMesh(monkeyMesh);
			renderer->SetMaterial(monkeyMaterial);
		...
		GameObject::Sptr monkey22 = scene->CreateGameObject("Complex Object");
		{
			// Set and rotation position in the scene
			monkey22->SetPostion(glm::vec3(0.0f, -3.0f, 0.280f));
			monkey22->SetRotation(glm::vec3(0.0f, 45.0f, -90.0f));

			// Add a render component
			RenderComponent::Sptr renderer = monkey22->Add<RenderComponent>();
			renderer->SetMesh(monkeyMesh);
			renderer->SetMaterial(monkeyMaterial);
